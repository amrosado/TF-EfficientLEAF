...
model_load_path = os.path.join('saved_models', '20230405_054817', 'model.16-0.21.h5')
...
history = model.fit(x=train_seq, validation_data=val_seq, callbacks=model_callbacks, epochs=30, initial_epoch=16)
